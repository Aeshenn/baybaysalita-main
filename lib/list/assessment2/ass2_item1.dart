...
class assess2Item1 extends StatefulWidget {
  @override
  State<assess2Item1> createState() => _assess2Item1State();
}

class _assess2Item1State extends State<assess2Item1> {
    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: Column(children: [
              ...
              MaterialButton(
                  onPressed: () {
                    Navigator.pushNamed(context, AllRoutes.assess2Item2Route);
                  },
