...
class assess3Item1 extends StatefulWidget {
  @override
  State<assess3Item1> createState() => _assess3Item1State();
}

class _assess3Item1State extends State<assess3Item1> {
    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: Column(children: [
              ...
              MaterialButton(
                  onPressed: () {
                    Navigator.pushNamed(context, AllRoutes.assess3Item2Route);
                  },
