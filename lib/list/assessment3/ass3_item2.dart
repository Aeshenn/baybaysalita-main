...
class assess3Item2 extends StatefulWidget {
  @override
  State<assess3Item2> createState() => _assess3Item2State();
}

class _assess3Item2State extends State<assess3Item2> {
    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: Column(children: [
              ...
              MaterialButton(
                  onPressed: () {
                    Navigator.pushNamed(context, AllRoutes.assess3Item3Route);
                  },
