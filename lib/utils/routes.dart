class AllRoutes {
  ...
  static String quiz1Route = "/quiz1"; //Quiz1

  static String story2Item2Route = "/assess4-story2";
  static String quiz2Route = "/quiz2"; //Quiz2

  static String story3Item3Route = "/assess4-story3";
  static String quiz3Route = "/quiz3"; //Quiz3
